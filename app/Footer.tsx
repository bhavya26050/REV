                    ...
                    <div className="flex flex-wrap md:text-left text-center order-first">
                        <div className="lg:w-1/3 md:w-1/2 w-full px-4">
                            ...
                            <nav className="list-none mb-10">
                                <li>
                                    <a className="text-gray-100 hover:text-indigo-300">First Link</a>
                                </li>
                                <li>
                                    <a className="text-gray-100 hover:text-indigo-300">Second Link</a>
                                </li>
                                <li>
                                    <a className="text-gray-100 hover:text-indigo-300">Third Link</a>
                                </li>
                                <li>
                                    <a className="text-gray-100 hover:text-indigo-300">Fourth Link</a>
                                </li>
                            </nav>
                        </div>
                        <div className="lg:w-1/3 md:w-1/2 w-full px-4">
                        ...
                        <div className="lg:w-1/3 md:w-1/2 w-full  px-4">
                            ...
                            <div className="flex xl:flex-nowrap md:flex-nowrap lg:flex-wrap flex-wrap justify-center items-end md:justify-start">
                                ...
                                <button className="lg:mt-2 xl:mt-0 flex-shrink-0 inline-flex text-white bg-indigo-500 border-0 py-2 px-6 focus:outline-none hover:bg-indigo-600 hover:text-black rounded">Button</button>
                            </div>
                            <p className="text-gray-200 text-sm mt-2 md:text-left text-center">Bitters chicharrones fanny pack        </p>
                        </div>
                    </div>
                </div>
                <div className="bg-transparent">
                    <div className="container px-5 py-6 mx-auto flex items-center sm:flex-row flex-col">
                        <a className="flex title-font font-medium items-center md:justify-start justify-center text-white">
                            ...
                            <span className="ml-3 text-xl">REV</span>
                        </a>
                        <p className="text-sm text-white sm:ml-6 sm:mt-0 mt-4">
                            © {new Date().getFullYear()} 
                            <a href="#" rel="noopener noreferrer" className="text-white ml-1" target="_blank">@bhavya</a>
                        </p>
